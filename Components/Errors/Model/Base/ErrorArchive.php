<?php
/**
 * Data model for table "errors_archive"
 *
 * @category  DataModel
 * @package   DataModel
...
abstract class ErrorArchive extends \Framework\CMS\ORM\Record
{
    const TABLE_NAME = 'errors_archive';

    const MODEL_NAME = 'Components\Errors\Model\ErrorArchive';
